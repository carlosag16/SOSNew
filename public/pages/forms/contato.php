...
require '../../../app/functions/debug_functions.php';
...
if($captcha){
  ...
  if($resposta['success'] == true){
    ...
    <strong>Local: https://conferenciaweb.rnp.br/webconf/francisca-moreira-pomin</strong> <br>
    <br>
    ...
    <br><br>
    <strong>IMPORTANTE:</strong> No dia {$newDate->format('d/m/Y')}, dirija-se a sala de reunião na sala com 10 minutos de antecedência.
    <br><br>
    <br>
    <br>
