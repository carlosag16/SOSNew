...
<div class="info-box">
	Confirmação de dados e Link para sua conferência online.
...
if($captcha){
  ...
  if($resposta['success'] == true){
    ...
    $servidorSala = DBReadOne("ser_servidores","ser_sala","WHERE ser_id = \"$horario_ser_id\"");
    ...
    <strong>Local:</strong> <a href=>{$servidorSala}</a><br>
    <br>
